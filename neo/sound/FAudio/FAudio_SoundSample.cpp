...
/*
========================
idSoundSample_FAudio::idSoundSample_FAudio
========================
*/
idSoundSample_FAudio::idSoundSample_FAudio() {
...
/*
========================
idSoundSample_FAudio::WriteGeneratedSample
========================
*/
void idSoundSample_FAudio::WriteGeneratedSample( idFile *fileOut ) {
...
/*
========================
idSoundSample_FAudio::WriteAllSamples
========================
*/
void idSoundSample_FAudio::WriteAllSamples( const idStr &sampleName ) {
	idSoundSample_FAudio * samplePC = new idSoundSample_FAudio();
	{
...
/*
========================
idSoundSample_FAudio::LoadGeneratedSound
========================
*/
bool idSoundSample_FAudio::LoadGeneratedSample( const idStr &filename ) {
...
/*
========================
idSoundSample_FAudio::Load
========================
*/
void idSoundSample_FAudio::LoadResource() {
	FreeData();
...
/*
========================
idSoundSample_FAudio::LoadWav
========================
*/
bool idSoundSample_FAudio::LoadWav( const idStr & filename ) {
...
/*
========================
idSoundSample_FAudio::MakeDefault
========================
*/
void idSoundSample_FAudio::MakeDefault() {
	FreeData();
...
/*
========================
idSoundSample_FAudio::LoadAmplitude
========================
*/
bool idSoundSample_FAudio::LoadAmplitude( const idStr & name ) {
	amplitude.Clear();
...
/*
========================
idSoundSample_FAudio::GetAmplitude
========================
*/
float idSoundSample_FAudio::GetAmplitude( int timeMS ) const {
