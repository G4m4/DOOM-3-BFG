...
===========================================================================
*/
#ifndef __FAUDIO_SOUNDHARDWARE_H__
#define __FAUDIO_SOUNDHARDWARE_H__

class idSoundHardware_FAudio;
class idSoundSample_FAudio;

#include "FAudio_SoundVoice.h"
...
================================================
*/
class idSoundEngineCallback : public FAudioEngineCallback {
public:
	idSoundHardware_FAudio * hardware;
