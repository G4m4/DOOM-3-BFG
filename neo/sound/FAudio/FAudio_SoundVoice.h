...
===========================================================================
*/
#ifndef __FAUDIO_SOUNDVOICE_H__
#define __FAUDIO_SOUNDVOICE_H__
...
================================================
*/
class idSoundVoice_FAudio : public idSoundVoice_Base {
public:
							idSoundVoice_FAudio();
							~idSoundVoice_FAudio();
	...
	bool					CompatibleFormat( idSoundSample_FAudio * s );

	uint32					GetSampleRate() const { return sampleRate; }

	// callback function
	void					OnBufferStart( idSoundSample_FAudio * sample, int bufferNumber );
...
private:
	...
	int						SubmitBuffer( idSoundSample_FAudio * sample, int bufferNumber, int offset );
	...
	FAudioSourceVoice *	pSourceVoice;
	idSoundSample_FAudio * leadinSample;
	idSoundSample_FAudio * loopingSample;
...
================================================
*/
class idSoundVoice : public idSoundVoice_FAudio {
};
