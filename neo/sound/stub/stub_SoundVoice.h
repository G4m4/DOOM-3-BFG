...
===========================================================================
*/
#ifndef __STUB_SOUNDVOICE_H__
#define __STUB_SOUNDVOICE_H__
...
================================================
*/
class idSoundVoice_stub : public idSoundVoice_Base {
public:
							idSoundVoice_stub();
							~idSoundVoice_stub();
	...
	bool					CompatibleFormat( idSoundSample_stub * s );

	uint32					GetSampleRate() const { return sampleRate; }

	// callback function
	void					OnBufferStart( idSoundSample_stub * sample, int bufferNumber );

private:
	friend class idSoundHardware_stub;
	...
	int						SubmitBuffer( idSoundSample_stub * sample, int bufferNumber, int offset );
	...
	void *	pSourceVoice;
	idSoundSample_stub * leadinSample;
	idSoundSample_stub * loopingSample;
...
================================================
*/
class idSoundVoice : public idSoundVoice_stub {
};
