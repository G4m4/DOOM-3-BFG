...
/*
========================
idSoundSample_stub::idSoundSample_stub
========================
*/
idSoundSample_stub::idSoundSample_stub() {
...
/*
========================
idSoundSample_stub::WriteGeneratedSample
========================
*/
void idSoundSample_stub::WriteGeneratedSample( idFile *fileOut ) {
...
/*
========================
idSoundSample_stub::WriteAllSamples
========================
*/
void idSoundSample_stub::WriteAllSamples( const idStr &sampleName ) {
	idSoundSample_stub * samplePC = new idSoundSample_stub();
	{
...
/*
========================
idSoundSample_stub::LoadGeneratedSound
========================
*/
bool idSoundSample_stub::LoadGeneratedSample( const idStr &filename ) {
...
/*
========================
idSoundSample_stub::Load
========================
*/
void idSoundSample_stub::LoadResource() {
	FreeData();
...
/*
========================
idSoundSample_stub::LoadWav
========================
*/
bool idSoundSample_stub::LoadWav( const idStr & filename ) {
...
/*
========================
idSoundSample_stub::MakeDefault
========================
*/
void idSoundSample_stub::MakeDefault() {
	FreeData();
...
/*
========================
idSoundSample_stub::LoadAmplitude
========================
*/
bool idSoundSample_stub::LoadAmplitude( const idStr & name ) {
	amplitude.Clear();
...
/*
========================
idSoundSample_stub::GetAmplitude
========================
*/
float idSoundSample_stub::GetAmplitude( int timeMS ) const {
