...
===========================================================================
*/
#ifndef __STUB_LOCALUSER_H__
#define __STUB_LOCALUSER_H__
...
================================================
*/
class idLocalUserStub : public idLocalUser {
public:
	...
	//==========================================================================================
	// idLocalUserStub interface
	//==========================================================================================
	void						SetInputDevice( int inputDevice_ ) { inputDevice = inputDevice_; }
	void						SetGamerTag( const char * gamerTag_ ) { gamertag = gamerTag_; }
	stubUserState_t				GetUserState() { stubUserState_t a = { inputDevice }; return a; }
	bool						VerifyUserState( stubUserState_t & state );
