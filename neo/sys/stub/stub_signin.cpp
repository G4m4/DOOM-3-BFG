...
#ifdef _DEBUG
idCVar stub_userPersistent( "stub_userPersistent", "1", CVAR_BOOL, "debugging cvar for profile persistence status" );
idCVar stub_userOnline( "stub_userOnline", "1", CVAR_BOOL, "debugging cvar for profile online status" );
idCVar stub_isInParty( "stub_isInParty", "0", CVAR_BOOL, "debugging cvar for platform party status" );
idCVar stub_partyCount( "stub_partyCount", "0", CVAR_INTEGER, "debugginc var for platform party count" );
#endif

/*
========================
idSignInManagerStub::Shutdown
========================
*/
void idSignInManagerStub::Shutdown() {
}

/*
========================
idSignInManagerStub::Pump
========================
*/
void idSignInManagerStub::Pump() {
...
/*
========================
idSignInManagerStub::RemoveLocalUserByIndex
========================
*/
void idSignInManagerStub::RemoveLocalUserByIndex( int index ) {
...
/*
========================
idSignInManagerStub::RegisterLocalUser
========================
*/
...
/*
========================
idSignInManagerStub::CreateNewUser
========================
*/
bool idSignInManagerStub::CreateNewUser( stubUserState_t & state ) {
