...
#ifndef __STUB_LOCAL_H__
#define __STUB_LOCAL_H__

#include "../../renderer/OpenGL/glext.h"		// windows OpenGL extensions
...
struct StubVars_t {
	...
	static idCVar	stub_allowAltTab;
	static idCVar	stub_notaskkeys;
	static idCVar	stub_username;
	static idCVar	stub_outputEditString;
	static idCVar	stub_viewlog;
	static idCVar	stub_timerUpdate;
	static idCVar	stub_allowMultipleInstances;
...
extern StubVars_t	stubInstance;

#endif /* !__STUB_LOCAL_H__ */
