...
idCVar StubVars_t::sys_arch( "sys_arch", "", CVAR_SYSTEM | CVAR_INIT, "" );
idCVar StubVars_t::sys_cpustring( "sys_cpustring", "detect", CVAR_SYSTEM | CVAR_INIT, "" );
idCVar StubVars_t::in_mouse( "in_mouse", "1", CVAR_SYSTEM | CVAR_BOOL, "enable mouse input" );
idCVar StubVars_t::stub_allowAltTab( "stub_allowAltTab", "0", CVAR_SYSTEM | CVAR_BOOL, "allow Alt-Tab when fullscreen" );
idCVar StubVars_t::stub_notaskkeys( "stub_notaskkeys", "0", CVAR_SYSTEM | CVAR_INTEGER, "disable windows task keys" );
idCVar StubVars_t::stub_username( "stub_username", "", CVAR_SYSTEM | CVAR_INIT, "windows user name" );
idCVar StubVars_t::stub_outputEditString( "stub_outputEditString", "1", CVAR_SYSTEM | CVAR_BOOL, "" );
idCVar StubVars_t::stub_viewlog( "stub_viewlog", "0", CVAR_SYSTEM | CVAR_INTEGER, "" );
idCVar StubVars_t::stub_timerUpdate( "stub_timerUpdate", "0", CVAR_SYSTEM | CVAR_BOOL, "allows the game to be updated while dragging the window" );
idCVar StubVars_t::stub_allowMultipleInstances( "stub_allowMultipleInstances", "0", CVAR_SYSTEM | CVAR_BOOL, "allow multiple instances running concurrently" );

StubVars_t	stubInstance;
...
const char *Sys_GetProcessorString() {
	return stubInstance.sys_cpustring.GetString();
}
...
void Win_Frame() {
	...
	if ( stubInstance.stub_viewlog.IsModified() ) {
		stubInstance.stub_viewlog.ClearModified();
	}
}
