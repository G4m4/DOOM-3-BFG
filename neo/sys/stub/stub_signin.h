...
===========================================================================
*/
#ifndef __STUB_SIGNIN_H__
#define __STUB_SIGNIN_H__
...
================================================
*/
class idSignInManagerStub : public idSignInManagerBase {
public:

			idSignInManagerStub() : dlcVersionChecked( false ) {}
	virtual ~idSignInManagerStub() {}
	...
	bool							CreateNewUser( stubUserState_t & state );

private:
	idStaticList< idLocalUserStub, MAX_INPUT_DEVICES >	localUsers;
