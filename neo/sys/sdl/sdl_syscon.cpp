...
void Sys_CreateConsole() {
	s_wcd.hWnd = SDL_CreateWindow(GAME_NAME,
...
void Sys_ShowConsole( int visLevel, bool quitOnClose ) {
	...
	switch ( visLevel ) {
		case 0:
			SDL_HideWindow( s_wcd.hWnd, SW_HIDE );
		break;
		case 1:
			SDL_ShowWindow( s_wcd.hWnd, SW_SHOWNORMAL );
			//SendMessage( s_wcd.hwndBuffer, EM_LINESCROLL, 0, 0xffff );
		break;
		case 2:
			SDL_MinimizeWindow( s_wcd.hWnd );
		break;
		default:
