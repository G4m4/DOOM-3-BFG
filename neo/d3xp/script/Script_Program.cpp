...
idTypeDef	type_scriptevent( ev_scriptevent, &def_scriptevent, "scriptevent", sizeof(uintptr_t), NULL );
idTypeDef	type_namespace( ev_namespace, &def_namespace, "namespace", sizeof(uintptr_t), NULL );
...
idTypeDef	type_entity( ev_entity, &def_entity, "entity", sizeof(uintptr_t), NULL );					// stored as entity number pointer
idTypeDef	type_field( ev_field, &def_field, "field", sizeof(uintptr_t), NULL );
idTypeDef	type_function( ev_function, &def_function, "function", sizeof(uintptr_t), &type_void );
idTypeDef	type_virtualfunction( ev_virtualfunction, &def_virtualfunction, "virtual function", sizeof(uintptr_t), NULL );
idTypeDef	type_pointer( ev_pointer, &def_pointer, "pointer", sizeof(uintptr_t), NULL );
idTypeDef	type_object( ev_object, &def_object, "object", sizeof(uintptr_t), NULL );					// stored as entity number pointer
